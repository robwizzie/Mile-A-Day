...
-- Rarity follows iOS Badge.rarity computation so existing earned badges keep the same rarity on migration.
...
INSERT INTO badges (badge_id, category, name, description, icon, rarity, requirement, is_hidden, sort_order) VALUES
  ...
  ('streak_60',      'streak',          'Two Month Milestone',   '60 day streak!',   'flame.fill',  'common',     60,   FALSE, 19),
  ('streak_75',      'streak',          'Consistency King',      '75 day streak!',   'flame.fill',  'rare',       75,   FALSE, 20),
  ('streak_90',      'streak',          'Quarter Year Hero',     '90 day streak!',   'flame.fill',  'common',     90,   FALSE, 21),
  ('streak_100',     'streak',          'Century Club',          '100 day streak!',  'flame.fill',  'rare',       100,  FALSE, 22),
  ('streak_120',     'streak',          'Four Month Fury',       '120 day streak!',  'flame.fill',  'common',     120,  FALSE, 23),
  ('streak_150',     'streak',          'Unstoppable Force',     '150 day streak!',  'flame.fill',  'rare',       150,  FALSE, 24),
  ('streak_180',     'streak',          'Half Year Hero',        '180 day streak!',  'flame.fill',  'common',     180,  FALSE, 25),
  ('streak_200',     'streak',          'Double Century',        '200 day streak!',  'flame.fill',  'rare',       200,  FALSE, 26),
  ('streak_250',     'streak',          'Legendary Streak',      '250 day streak!',  'flame.fill',  'common',     250,  FALSE, 27),
  ('streak_300',     'streak',          '300 Club',              '300 day streak!',  'flame.fill',  'common',     300,  FALSE, 28),
  ...
  ('streak_730',     'streak',          'Two Year Titan',        '730 day streak!',  'flame.fill',  'common',     730,  FALSE, 31),
  ...
  ('miles_1500',     'miles',           '1500 Mile Legend',      'Ran 1500 total miles!', 'figure.run', 'common',    1500, FALSE, 119),
  ('miles_2000',     'miles',           '2000 Mile Legend',      'Ran 2000 total miles!', 'figure.run', 'common',    2000, FALSE, 120),
  ...
  ('daily_50k',      'daily_distance',  '50K Ultra',             'Ran 31+ miles (50K) in one day!', 'location.fill', 'common',    31,   FALSE, 320),
  ...
  -- Hidden (11) — all legendary, not shown in locked catalog
  ('hidden_perfect_10',      'hidden',  'Perfect 10',            'Ran exactly 10.00 miles in one day!',       'sparkles', 'legendary', NULL, TRUE, 610),
  ('hidden_lucky_7',         'hidden',  'Lucky Seven',           'Ran 7+ miles on day 7 of your streak!',     'sparkles', 'legendary', NULL, TRUE, 611),
  ('hidden_double_trouble',  'hidden',  'Double Trouble',        'Hit exactly 22 total miles!',               'sparkles', 'legendary', NULL, TRUE, 612),
  ('hidden_century_double',  'hidden',  'Century Double',        '100 day streak AND 100+ total miles!',      'sparkles', 'legendary', NULL, TRUE, 613),
  ('hidden_speed_endurance', 'hidden',  'Speed & Endurance',     'Sub-8 min pace AND 5+ mile day!',           'sparkles', 'legendary', NULL, TRUE, 614),
  ('hidden_marathon_pace',   'hidden',  'Marathon Master',       'Marathon distance with sub-10 min pace!',   'sparkles', 'legendary', NULL, TRUE, 615),
  ('hidden_triple_threat',   'hidden',  'Triple Threat',         '30 day streak, 30+ miles, 3+ mile day!',    'sparkles', 'legendary', NULL, TRUE, 616),
  ('hidden_50_50',           'hidden',  '50/50 Club',            '50 day streak AND 50+ total miles!',        'sparkles', 'legendary', NULL, TRUE, 617),
  ('hidden_year_miles',      'hidden',  'Year in Miles',         'Ran 365 total miles — a mile for every day of the year!', 'sparkles', 'legendary', NULL, TRUE, 618),
  ('hidden_thousand_club',   'hidden',  'Thousand Club',         'Reached 1000 in days OR miles!',            'sparkles', 'legendary', NULL, TRUE, 619),
  ('hidden_pace_perfect',    'hidden',  'Pace Perfectionist',    'Sub-7 pace AND 10+ mile day!',              'sparkles', 'legendary', NULL, TRUE, 620)
