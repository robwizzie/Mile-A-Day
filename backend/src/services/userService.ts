...
export async function createUser({ email, apple_id }: { email: string; apple_id: string }) {
	...
	await db.query('INSERT INTO users (user_id,  email,  apple_id) VALUES ($1, $2, $3)', [user_id, email, apple_id]);
