...
export function HeroSection() {
	return (
		<section
			...
			style={{
				background:
					'radial-gradient(ellipse 600px 600px at 50% -10%, rgba(199,37,84,0.07) 0%, transparent 70%), radial-gradient(ellipse 400px 400px at -10% 90%, rgba(139,21,56,0.05) 0%, transparent 70%)'
			}}
		>
			<div className="relative mx-auto flex max-w-6xl flex-col items-center gap-16 lg:flex-row lg:items-center lg:gap-20">
				...
				<div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
					<div className="animate-fade-in-up glass-card-highlight mb-6 inline-flex items-center gap-2 rounded-full px-4 py-2">
						...
						<span className="text-xs font-medium tracking-wide text-[#c72554]">Available on iOS & Apple Watch</span>
					</div>
					...
					<p className="animate-fade-in-up animate-delay-200 mt-6 max-w-lg text-lg leading-relaxed text-[#a0a0a0]">
						The simplest fitness challenge that will change your life. No complicated programs. No expensive gear.
						Just lace up, tap Start Mile, and go. Walk it or run it — just get it done.
					</p>
					...
					{/* Social proof stats */}
					<div className="animate-fade-in-up animate-delay-400 mt-10 flex flex-wrap justify-center gap-x-8 gap-y-5 sm:gap-x-12 lg:justify-start">
						<LiveUserCount />
				...
				<div className="animate-fade-in-up animate-delay-200 relative flex flex-1 items-center justify-center">
					...
					{/* Glow behind phone */}
					<div
						className="absolute -z-10 h-[400px] w-[400px] rounded-full"
						style={{ background: 'radial-gradient(circle, rgba(199,37,84,0.08) 0%, transparent 70%)' }}
					/>
				</div>
			</div>
		</section>
