...
struct User: Identifiable, Codable {
    ...
    private func getLockedBadges() -> [Badge] {
        ...
        let socialBadges: [(String, String, String)] = [
            ...
            ("nudge_1", "First Nudge", "Nudged a friend to get their mile in"),
            ("nudge_25", "Motivator", "Sent 25 nudges"),
            ("nudge_100", "Accountability Partner", "Sent 100 nudges"),
            ("nudge_500", "Hype Coach", "Sent 500 nudges"),
